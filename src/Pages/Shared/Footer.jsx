            ...
            <div className="mx-auto px-[3vw] lg:px-[6vw] relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-[6vw]">
                    ...
                    <div className="flex flex-col items-center lg:items-start justify-center">
                        <h3 className="text-white text-[18px] mg:text-[22px] lg:text-[32px] font-bold mb-4">Mega Mart</h3>
                        <p className="text-gray-300 text-[12px] mg:text-[12px] lg:text-[20px]">Explore premium products with us!</p>
                    </div>
                    {/* Contact Information */}
                    <div className="flex flex-col items-center justify-center">
                        <h4 className="text-white text-[12px] mg:text-[12px] lg:text-[20px] font-semibold mb-4">Contact Us</h4>
                        <p className="text-gray-300 text-[12px] mg:text-[12px] lg:text-[20px]">Email:info@megamart.com</p>
                        <p className="text-gray-300 text-[12px] mg:text-[12px] lg:text-[20px]">Phone: 01784411785</p>
                    </div>
                    {/* Social Media Links */}
                ...
                <div className="mt-8 text-center">
                    <p className="text-gray-300 text-[12px] mg:text-[12px] lg:text-[20px]">© 2024 Mega Mart. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
