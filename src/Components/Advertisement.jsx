...
{
        advertised.slice(36,40).map(property =>  <SwiperSlide key={property?._id} >       <div className="relative mb-[50px] w-[300px] mx-auto rounded overflow-hidden shadow-lg">
        <img src={property.productImage} alt={property.Title} className="w-[300px] h-[180px] object-cover" />
        <div className="px-[10px] h-[160px]">
        <div className="font-bold text-[3.5vw] md:text-[1.5vw]">{property.productName}</div> 
            <p className="text-[8px] md:text-[15px]">
                <span className="font-semibold">Category:</span> ${property.category}
            </p>
            <p className="text-[8px] md:text-[15px]">
            <span className="font-semibold"></span>
                <span className=""> Price: </span>${property.price}
            </p>
            <p className="text-[8px] md:text-[15px]">
                <span className="font-semibold">Rating:</span> {property.ratings}
            </p>                
        </div>
